    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3 needs-validation" novalidate 
                ...
                <div class="col-12">
                    ...
                    <input class="form-control" type="file" id="resumeFile" name="resumeFile" accept=".pdf, .docx" >
                ...
                <div class="col-12 text-center mt-4">
                    <button class="btn btn-primary btn-lg" type="submit" name = "Submit">ส่งใบสมัคร</button>
        ...
        <div class="card-footer text-muted text-center">
            ...
            if (isset($_POST['Submit'])) {
				...
				$sql = "INSERT INTO application (a_id, a_jobPosition, a_prefix, a_firstName, a_lastName, a_birthDate, a_phoneNumber, a_email, a_educationLevel, a_institutionName, a_faculty, a_gpa, a_specialSkills, a_workExperience) VALUES (NULL, '{$jobPosition}', '{$prefix}', '{$firstName}', '{$lastName}', '{$birthDate}', '{$phoneNumber}', '{$email}', '{$educationLevel}', '{$institutionName}', '{$faculty}', '{$gpa}', '{$specialSkills}', '{$workExperience}');";
